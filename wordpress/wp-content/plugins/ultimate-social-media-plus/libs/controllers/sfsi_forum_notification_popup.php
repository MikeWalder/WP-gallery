		...
		<div class="usm-plus-widget__body">
			...
			<div class="usm-plus-widget__content">
				<div class="usm-plus-widget__text-content">
					<p class="usm-plus-widget__title"><?php _e( 'Do the social media icons show like you want to?', 'ultimate-social-media-icons' ); ?></p>
					...
					?></p>
					<p class="usm-plus-widget__text"><?php _e( 'We can also consult you how to place them for maximum effect & assist with anything else.', 'ultimate-social-media-icons' ); ?></p>
				...
				<p class="usm-plus-widget__footer-bottom-text"><?php _e( 'By Ultimatelysocial', 'ultimate-social-media-icons' ); ?></p>
			</div>
		</div>
	</div>
<?php
