...
if (!is_plugin_active('Ultimate-Premium-Plugin/usm_premium_icons.php')) {
	...
	define( 'SFSI_PLUS_PLUGIN_VERSION', '3.5.1' );
	...
	if (!get_option('sfsi_plus_pluginVersion') || get_option('sfsi_plus_pluginVersion') < 3.51) {
	...
	function sfsi_plus_admin_notice()
	{
		...
		<?php
			...
			<div class="sfsi_plus_askforhelp askhelpInview<?php echo $viewNumber; ?>">
				...
				<span><?php
					printf(
						__( 'Have issues? %1$sAsk us in the forum%2$s - %3$sit\'s FREE and quick!', SFSI_PLUS_DOMAIN ),
